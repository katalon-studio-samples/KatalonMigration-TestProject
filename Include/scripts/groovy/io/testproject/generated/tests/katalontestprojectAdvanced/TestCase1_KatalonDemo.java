 ...
 * Generated on Thu Dec 08 09:58:02 GMT 2022.
 */
@DisplayName("Book an Appointment")
public class TestCase1_KatalonDemo {
  public static WebDriver driver;
  String ApplicationURL ="https://katalon-demo-cura.herokuapp.com/";
  String URLKatalonDocs ="https://docs.katalon.com/";
  ...
  void execute() throws Exception {
    ...
    TestCase2_KatalonDocs webkatalondocs;
    ...
    // 20. Run WEB- Katalon Docs
    GeneratedUtils.sleep(500);
    webkatalondocs = new TestCase2_KatalonDocs();
    webkatalondocs.ApplicationURL = URLKatalonDocs;
    webkatalondocs.execute(driver);
